t = cputime;
filename = 'sista.dat'%Identify the original file name
fid = fopen(filename,'r'); %Open this file only to read
xe = zeros(12334,1); %Initialize a vector of 9947 rows times 1 Column
Xtest = zeros(12334,1408);%Initialize a vector of 9947 rows times 600 Column
